        ...
        <div class="tbl_box">
	          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl_type01" summary="설문조사">
	            ...
	            <tbody>
	              <tr>
	                <th>제목</th>
	                <td colspan="5" class="tl"><input type="text" id="surTitle" name="surTitle" /></td>
	                </tr>
	              <tr>
	                <th>시작일</th>
...
<script type="text/javascript">
 	...
 	$(document).ready(function(){
		$("#create").click(function(){
			...
			var attachPath = $("#attachPath").val(); //첨부파일

			//문제 문항들 
			var suriArray = [];
			$('input[name="suriTitle"]').each(function(i){
	  ...
	  function fn_selectcnt(queCnt){
		...
		$("#research").empty();
			for(var i =1; i<=selectCnt ;i++){
					...
					var line =$("</ul><br>");
					$(div).append(c_title,q1,q2,q3,q4,q5,line);
					$("#research").append(div);
			}
		} 
